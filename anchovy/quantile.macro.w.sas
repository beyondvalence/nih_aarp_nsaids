...
/********************************************************************************************************/
/*                                                                                                      */
/*  The quantile macro creates trend and dummy variables for the specified quantiles of a variable.     */
/*  It creates a variable which specifies which quantile the value belongs in, as well as               */
/*  a variable that holds the median values for each level, and dummy variables for each level.         */
/*                                                                                                      */
/*  The quantile macro uses the following variables:                                                    */
/*                                                                                                      */
...
/*    %quantile(COHORT,pctfat,pctfatQ,5,0);                                                             */
/*                                                                                                      */
/*  The variables created would be named:                                                               */
/*    pctfatQ  - categorical variable with values of 1,2,3,4,5                                          */
/*    pctfatQM - categorical variable with median values in each of 5 levels                            */
/*    pctfatQ1 - dummy variable (0/1) indicating value isn't/is in quintile 1                           */
/*    pctfatQ2 - dummy variable (0/1) indicating value isn't/is in quintile 2                           */
/*    pctfatQ3 - dummy variable (0/1) indicating value isn't/is in quintile 3                           */
/*    pctfatQ4 - dummy variable (0/1) indicating value isn't/is in quintile 4                           */
/*    pctfatQ5 - dummy variable (0/1) indicating value isn't/is in quintile 5                           */
/*                                                                                                      */
/********************************************************************************************************/
